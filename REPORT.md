...
|---|---|---:|---:|---:|---:|---:|---:|
| 문화포털 전시 | API | 7 | 7 | 3/3 | 7,033자 | 2,142 | **23건** |
| 경향 문화 | RSS | 50 | 50 | 2/3 | 1,055자 | 423 | 14건 |
| Colossal | RSS | 10 | 10 | 3/3 | 2,327자 | 1,932 | 12건 |
| 오마이뉴스 문화 | RSS | 20 | 20 | 3/3 | 2,998자 | 2,636 | 8건 |
...
`report_card.py` 는 `.get()` 기본값으로 읽으므로, `quota_dropped` 같은 새 필드가 생겨도 **과거 7행과 새 스키마 14행을 함께 읽고 깨지지 않습니다.** (회귀 확인 완료 — 위 출력이 21회 전부를 읽은 결과입니다.)
